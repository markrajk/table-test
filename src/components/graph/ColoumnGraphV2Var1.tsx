...
const ColoumnGraphV2Var1 = () => {
  ...
  const element = document.getElementById('coloumn-graph-v2-var1-widget')
    ...
    <div className="widget widget-column-chart">
      <div className="widget-header">
        <p className="widget-header-title">
          Overview how Julia Martinez is doing at the moment
        </p>
        <p className="widget-header-text">
          Average of all given reviews during the last two months - Period
          1.8.2020-1.10-2020
        </p>
      ...
      <div className="widget-body">
        <div className="column-chart cc-v02" id="coloumn-graph-v2-var1-widget">
          <div className="column-chart-area">
            <div className="column-chart-area-graph">
              <div className="column-chart-area-graph-set">
                <div
                  className="column-chart-area-graph-set-item stripped"
                  style={{ height: '80%' }}
                >
                  <i className="icon-user"></i>
                </div>
                <div
                  className="column-chart-area-graph-set-item"
                  style={{ height: '70%' }}
                >
          ...
          <div className="column-chart-h-axis">
            ...
            <div className="column-chart-h-axis-item item-07">
              <p className="column-chart-h-axis-item-label">Overall average</p>
              <span className="column-chart-h-axis-item-tick"></span>
            </div>
          </div>
        </div>
...
export default ColoumnGraphV2Var1
