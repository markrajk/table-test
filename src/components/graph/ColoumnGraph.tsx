...
import { BarData, MyWidget, User } from 'src/apiTypes'
...
//import UserFeedbacks from '../modals/userFeedbacks'
...
const ColoumnGraph = (props: Props & PropsFromRedux) => {
  ...
  return (
    ...
    <div
      ...
      style={{ paddingBottom: noData ? 0 : undefined }}
    >
      <div
            ...
            <div className="column-chart">
                ...
                {(data?.data as BarData[])?.map((item) => {
                  ...
                  if (item.sender) {
                    return (
                      ...
                      >
                        {!!item.change && (
                          <p className="column-chart-area-item-label">
                            {(item.change > 0 ? '+' : '') +
              ...
              <div className="column-chart-x-axis" >
                {(data?.data as BarData[])?.map((item) => {
                  if (item.question) {
                    return (
                      <div className="column-chart-x-axis-item" onClick={() => {
                  ...
                  if (item.sender) {
                    return (
                      <div className="column-chart-x-axis-item" onClick={() => {
                        ...
                        selectUser(item.sender)
                        setUserFeedbackOpen(true)
                        document.getElementById('userFeedbacksHighOrder')?.classList.add('open')
                      }}>
                        <p className="column-chart-x-axis-item-label">
...
export default connector(ColoumnGraph)
