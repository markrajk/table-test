...
const mapDispatchToProps = (dispatch: AppDispatch) => ({
  ...
  getUserTextFeedback: (userId: string) =>
    dispatch(getUserTextFeedback(userId, 'supervisor')),
  ...
  setInviteModalType: () => dispatch(setInviteModalType('teamLeaders'))
})
...
const GeneralSettings = (props: Props) => {
  ...
  useEffect(() => {
    if (
      ...
      selectedTeamData?.teamLeaders[0] &&
      !selectedUser
    ) {
      selectUserState(selectedTeamData?.teamLeaders[0])
    }
  }, [selectedTeamData?.teamLeaders && selectedTeamData?.teamLeaders[0]])
          ...
          <div className="option-buttons">
            <button
              ...
              onClick={() => {
                if (selectedTeam) {
                  //@ts-ignore
                  push('/team/' + selectedTeam._id + '/data/supervisoryFeedback')
                }
              }}
            >
              {t("common:Charts")}
        ...
        <div className="text-feedback-content">
          <div className="content-card questions">
            ...
            <div className="questions-header">
              <p className="questions-header-title">{t("common:Selectteamleader")}</p>
            </div>
            <div className="questions-main">
              {selectedTeamData?.teamLeaders?.map((item) => (
                <div
                ...
                >
                  <p className="question-text">
                    {t("common:Teamleader")}{' '}- {item.firstname + ' ' + item.lastname}
                  </p>
              ...
              >
                ...
                {t('textFeedbackPages:Addnewteamleaders')}
              </button>
            </div>
          </div>
          ...
          <div className="content-card answers">
            <div className="answers-header">
              <p className="answers-header-title">
                {t("textFeedbackPages:Feedbackaboutteamleader")}{' '}{'->'}{' '}
                {selectedUser?.firstname + ' ' + selectedUser?.lastname}
              </p>

              <p className="answers-header-amount">
                {t("textFeedbackPages:Allreviewsgivenanonymously")}.
              </p>
            </div>
              ...
              {!!userTextFeedback?.length ? (
                userTextFeedback.map((feed) => (
                  ...
                  <div className="answers-placeholder">
                    ...
                    <p className="answers-placeholder-text" style={{ maxWidth: "23rem" }}>
                      {t("textFeedbackPages:Therehasnotyetbeengivenaboutteamleader")}{' '}
