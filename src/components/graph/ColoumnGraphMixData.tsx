...
import { BarData, MixData, MyWidget } from 'src/apiTypes'
          ...
          <div className="widget-placeholder">
            ...
            <div className="column-chart">
              ...
              <div className="column-chart-area">
                {(data?.data as MixData[])?.map((item) => {
                  if (item.averageSelf && item.averageP2p) {
                    return (
                      <div className="column-chart-area-item split">
                        {
                          <div
                            className="column-chart-area-item-split"
                            style={{
                              height: ((item.averageSelf - 1) / 4) * 100 + '%',
                              background: `repeating-linear-gradient(
                          -45deg,
                          ${ratingColor(item.averageSelf)},
                          ${ratingColor(item.averageSelf)} 6px,
                          #ffffff 6px,
                          #ffffff 7px
                        )`,
                            }}
                        ...
                        {!!item.averageP2p && (
                          <div
                            className="column-chart-area-item-split"
                            style={{
                              height: ((item.averageP2p - 1) / 4) * 100 + '%',
                              backgroundColor: ratingColor(item.averageP2p),
                            }}
                          >
                    ...
                    return (
                      <div
                        ...
                        style={{
                          height:
                            (((item.averageSelf || item.averageP2p) - 1) / 4) *
                            100 +
                            '%',
                          backgroundColor: ratingColor(
                            item.averageSelf || item.averageP2p
                          ),
                        }}
                      >
                ...
                {!!data?.received && (
                  <div
                    className="column-chart-area-item"
                    style={{
                      height: data?.received * 20 + '%',
                      backgroundColor: ratingColor(data?.received),
                    }}
                  >
                    <p className="column-chart-area-item-label"></p>
                  </div>
                ...
                {!!data?.sent && (
                  <div
                    ...
                    style={{
                      height: data?.sent * 20 + '%',
                      backgroundColor: ratingColor(data?.sent),
                    }}
                  >
                    <p className="column-chart-area-item-label"></p>
                  </div>
